...
static void my_application_activate(GApplication* application) {
  ...
  // Thx to petlyh -> https://gist.github.com/petlyh/0b52d80028534364ce89b62beae6c51c
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "Android App Manager");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "Android App Manager");
  }
